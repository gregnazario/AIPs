...
for more combinations of emojis to be used as a coin symbol.  This is an increase behind a feature flag to increase from
10 bytes to 32 bytes, and will need to adjust the indexer storage accordingly.
...
If this proposal doesn't happen, then we will be limited to 10 bytes for coin symbols.
